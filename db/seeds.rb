...
Order.create!(order_id: "#1234", date: "Faker::Date.forward(days: 23)", status: "Paid", customer_id: "4", product_id: "8")
Order.create!(order_id: "#6535", date: "Faker::Date.forward(days: 23)", status: "Overdue", customer_id: "2", product_id: "8")
Order.create!(order_id: "#6354", date: "Faker::Date.forward(days: 23)", status: "Sent", customer_id: "6", product_id: "7")
Order.create!(order_id: "#9035", date: "Faker::Date.forward(days: 23)", status: "Paid", customer_id: "7", product_id: "5")
Order.create!(order_id: "#5201", date: "Faker::Date.forward(days: 23)", status: "Sent", customer_id: "1", product_id: "2")  